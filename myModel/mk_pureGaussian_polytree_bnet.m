function bnet = mk_pureGaussian_polytree_bnet(CPD_type, arity)

% WSUN: 7/19/2009
% mk_Gaussian_polytree_bnet: create an example network consisting of purely 
% continuous varaibles distributed by linear Gaussian with the sturture as below
%
%           A         U
%            \       /
%             \     /
...
disp('Creating a pure continuous polytree network with linear Gaussian variables...');
...
bnet = mk_bnet(dag, ns, 'discrete', [], 'names', node_names); %no discrete nodes.
