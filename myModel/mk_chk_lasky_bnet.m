function bnet = mk_chk_lasky_bnet(CPD_type, arity)
...
%  make an equivalent network as following integrating the effect above 'Y'
%            B     (Y)
%           / \    /
%          /   \  /
%         C     (W)
...
if ~ismember(CPD_type, {'orig', 'rnd', 'nonlinear','verify'})
...
switch CPD_type
    case 'verify', 
        ...
        bnet.CPD{Y} = gaussian_CPD(bnet, Y, 'mean', -54, 'cov', 77) ;
