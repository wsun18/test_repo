function bnet = mk_abz_testnet4(CPD_type, arity)
...
%               (X)       D
%
% A, B, C, D, are discrete nodes.
% Z, X are continuous nodes.
%
% 

disp('Creating a test network -NO.4- consisting hybrid nodes ...');
...
switch CPD_type
    case 'orig', 
        ...
        bnet.CPD{D} = tabular_CPD(bnet, D, [.3 .6 .7 .4]); 
