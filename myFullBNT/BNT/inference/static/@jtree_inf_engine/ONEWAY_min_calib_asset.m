function minAsset = ONEWAY_min_calib_asset(engine, asset, evidence)
% This is to find the minimum global value, by min-propagation. Because we
% do not need to know the configuration of joint state associated with the
% min value, we can do a one-way min-propagation instead of regular
