function subapot = ASSET_project_to_subdomain_rev(apot,subdom)

%% This is to compute the asset over its sub domain from the
%% original asset table, using the method Robin described that obtaining
%% the row mins as the new asset table for the variable represented by the
%% row, and then consequencely using the column mins as the new asset table
%% for the variable represented by the column.
%% -wsun, 4/5/13
