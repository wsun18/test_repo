% =====================================================================
% 12 March 2011
% Trying to code a fast message passing algorithm, exploiting network
% structure and features of computing different messages, with the purpose
% of avoiding computation iterations and make the algorithm as fast as it
% can.
%
% First of all, if the network is a tree, given evidence, I can always find
% an optimized order to pass messages only once and provide exact inference
% results. 
%
% Second, 
% =======================================================================
...
function [msg bel iter] = fmp_hybrid_gmm(bnet, evidence)
...
% determine if the network is a tree by checking bnet.dag

% isTree = Check_netStructure(dag) ;
